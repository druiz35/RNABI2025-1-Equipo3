...
```{r}
write.csv(optimizacion$resultados_df, "rosenbrock_iter_pso.csv", row.names = FALSE)
```
...
```{r}
write.csv(optimizacion$resultados_df, "rastrigin_iter_pso.csv", row.names = FALSE)
```
