...
```{r}
# Tour más óptimo: 1  8  3 13 12  2  5  7  4 11  6  9 10
# Bogotá -> Ibagué -> Cali -> Pereira -> Manizales -> Medellín -> Cartagena
# -> Soledad -> Barranquilla -> Santa Marta -> Cúcuta -> Bucaramanga -> Villavicencio

# Rutas seleccionadas entre algunas ciudades
print("RUTA IDEAL: ")
print("Bogotá -> Ibagué -> Cali -> Pereira -> Manizales -> Medellín -> Cartagena -> Soledad -> Barranquilla -> Santa Marta -> Cúcuta -> Bucaramanga -> Villavicencio")
pares_rutas <- list(
  c("Bogotá", "Ibagué"),
  c("Ibagué", "Cali"),
  c("Cali", "Pereira"),
