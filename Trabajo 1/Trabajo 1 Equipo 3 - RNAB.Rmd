...
<div style="text-align: center;">
  <img src="rosenbrock_3d_grafica.png" alt="Gráfica de la función de Rosenbrock 2D" style="width:350px; max-width:90%; display:block; margin:auto;">
...
<div style="text-align: center;">
  <img src="rastrigin_opt.gif" alt="Animación de la función de Rastrigin 2D" style="width:350px; max-width:90%; display:block; margin:auto;">
...
<div style="text-align: center;">
  ...
  <div style="font-weight:bold; margin-top:8px; font-size:1.05em;">Gráficas de la optimización de Rastrigin 3D</div>
</div>
...
<div style="text-align: center;">
  <img src="rosenbrock_opt.gif" alt="Animación de la optimización de Rosenbrock 2D" style="width:350px; max-width:90%; display:block; margin:auto;">
...
<div style="text-align: center;">
  <img src="pso_rosenbrock_max.gif" alt="Animación de la optimización de Rosenbrock 3D" style="width:350px; max-width:90%; display:block; margin:auto;">
  <div style="font-weight:bold; margin-top:8px; font-size:1.05em;">Animación de la optimización de Rosenbrock 3D</div>
</div>
...
<div style="text-align: center;">
  <img src="rastrigin_opt.gif" alt="Animación de la optimización de Rastrigin 2D" style="width:350px; max-width:90%; display:block; margin:auto;">
  <div style="font-weight:bold; margin-top:8px; font-size:1.05em;">Animación de la optimización de Rastrigin 2D</div>
</div>
...
<div style="text-align: center;">
  <img src="pso_rastrigin_max.gif" alt="Animación de la optimización de Rastrigin 3D" style="width:350px; max-width:90%; display:block; margin:auto;">
  <div style="font-weight:bold; margin-top:8px; font-size:1.05em;">Animación de la optimización de Rastrigin 3D</div>
</div>
