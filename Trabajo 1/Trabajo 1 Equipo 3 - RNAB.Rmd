...
-   [2.3. Implementación Método de Algoritmos Genéticos](#io2.3.)
-   [2.5. Conclusiones](#io2.4.)
...
::: {style="text-align: center;"}
![**Figura 12.** Animación de optimización de Rastrigin 2D con Algoritmo Genético.](images/optim_rastrigin_ga-02.gif)
...
::: {style="text-align: center;"}
![**Figura 13.** Comparación de costos óptimos: ACO vs GA](images/ComparacionCostosOptimos.png)
...
::: {style="text-align: center;"}
::: {style="text-align: center;"}
![**Figura 14.** Comparación de costos óptimos: ACO vs GA](images/DesgloseCostos.png)
:::
