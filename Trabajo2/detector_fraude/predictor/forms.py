...
class PrediccionForm(forms.Form):
    ...
    total_pymnt = forms.FloatField(widget=forms.NumberInput(attrs={'class': 'form-control'}))
    total_pymnt_inv = forms.FloatField(widget=forms.NumberInput(attrs={'class': 'form-control'}))
    total_rec_prncp = forms.FloatField(widget=forms.NumberInput(attrs={'class': 'form-control'}))
    total_rec_int = forms.FloatField(widget=forms.NumberInput(attrs={'class': 'form-control'}))
    total_rec_late_fee = forms.FloatField(widget=forms.NumberInput(attrs={'class': 'form-control'}))
    recoveries = forms.FloatField(widget=forms.NumberInput(attrs={'class': 'form-control'}))
    collection_recovery_fee = forms.FloatField(widget=forms.NumberInput(attrs={'class': 'form-control'}))
    last_pymnt_amnt = forms.FloatField(widget=forms.NumberInput(attrs={'class': 'form-control'}))
